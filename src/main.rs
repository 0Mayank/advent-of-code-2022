...
fn main() {
    ...
    mods.insert("day13part1", Box::new(day13::part1::run));
    mods.insert("day13part2", Box::new(day13::part2::run));
    mods.insert("day14part1", Box::new(day14::part1::run));
    mods.insert("day14part2", Box::new(day14::part2::run));
